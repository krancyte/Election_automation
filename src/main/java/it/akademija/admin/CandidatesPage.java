...
public class CandidatesPage {
	...
	protected void editNameAndSurname(String number, String name, String surname, String birthDate, String newName, String newSurname, String newBirthDate, String newInfo, String newNumber) {
		menuCandidates.click();
		utilities.waitToLoad("//*[@id='searchable-table_filter']/label/input").sendKeys(number + " " + name + " " + surname + " " + birthDate);
		buttonEdit.click();
		//	countyRow = utilities.findElementForEditingCandidate(name, surname, birthDate, partyName);
	//	driver.findElement(By.xpath("//tbody/tr[" + countyRow + "]/td[6]/a[1]")).click();
		enterNewInformationForCandidate(newName, newSurname, newBirthDate, newInfo, newNumber);
		buttonSubmit.click();
	}
	
	protected void enterNewInformationForCandidate(String name, String surname, String birthDate, String info, String number) {
		candidateName.clear();
